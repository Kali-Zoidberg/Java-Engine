...
public  class SnakeObject {
	...
	public void createGraphics() { //rename because scope problems		
		snakgraph2d = render_obj.bi.createGraphics();
	...
	public boolean hasCollidedSnake (Snake sn, SnakeObject sno) { // CHANGE TO INT FUNCITON
